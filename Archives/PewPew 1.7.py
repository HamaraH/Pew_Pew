...
def ComparaisonDegats():
    ...
    if NombreCollisionJoueur1 != 4 and AncienneCollision!=CollisionsJoueur1[4] and Degats1==5:
        ZoneJeu.delete(VieJoueurDeux5)
        print(CollisionsJoueur1)
        print(NombreCollisionJoueur1)
        AncienneCollision=CollisionsJoueur1[4]
        Degats1=Degats1-1
    if NombreCollisionJoueur1 != 4 and AncienneCollision!=CollisionsJoueur1[4] and Degats1==4:
        ZoneJeu.delete(VieJoueurDeux4)
        AncienneCollision=CollisionsJoueur1[4]
        Degats1=Degats1-1
    if NombreCollisionJoueur1 != 4 and AncienneCollision!=CollisionsJoueur1[4] and Degats1==3:
        ZoneJeu.delete(VieJoueurDeux3)
        AncienneCollision=CollisionsJoueur1[4]
        Degats1=Degats1-1
    if NombreCollisionJoueur1 != 4 and AncienneCollision!=CollisionsJoueur1[4] and Degats1==2:
        ZoneJeu.delete(VieJoueurDeux2)
        AncienneCollision=CollisionsJoueur1[4]
        Degats1=Degats1-1
    if NombreCollisionJoueur1 != 4 and AncienneCollision!=CollisionsJoueur1[4] and Degats1==1:
    ...
    if NombreCollisionJoueur2 != 4 and AncienneCollision!=CollisionsJoueur2[4] and Degats2==5:
        ZoneJeu.delete(VieJoueurUn5)
        AncienneCollision=CollisionsJoueur2[4]
        Degats2=Degats2-1
    if NombreCollisionJoueur2 != 4 and AncienneCollision!=CollisionsJoueur2[4] and Degats2==4:
        ZoneJeu.delete(VieJoueurUn4)
        AncienneCollision=CollisionsJoueur2[4]
        Degats2=Degats2-1
    if NombreCollisionJoueur2 != 4 and AncienneCollision!=CollisionsJoueur2[4] and Degats2==3:
        ZoneJeu.delete(VieJoueurUn3)
        AncienneCollision=CollisionsJoueur2[4]
        Degats2=Degats2-1
    if NombreCollisionJoueur2 != 4 and AncienneCollision!=CollisionsJoueur2[4] and Degats2==2:
        ZoneJeu.delete(VieJoueurUn2)
        AncienneCollision=CollisionsJoueur2[4]
        Degats2=Degats2-1
    if NombreCollisionJoueur2 != 4 and AncienneCollision!=CollisionsJoueur2[4] and Degats2==1:
