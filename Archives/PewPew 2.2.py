...
def ComparaisonDegats():
    ...
    if Degats1==0 and CompteurBo==0:
        ...
        if Francais==1:
            ...
            """BoutonQuitter=Button(ZoneJeu,text="Fermer le jeu", height=5,width=30,command=Fermer)
            BoutonQuitter.place(x=1000,y=620)"""
        ...
        if Francais==0:
            ...
            #BoutonQuitter=Button(ZoneJeu,text="Close the game", height=5,width=30,command=Fermer)
            #BoutonQuitter.place(x=1000,y=620)
...
def Lancer():
        global CompteurBo, musiquematch,BoutonQuitter
        CompteurBo=0
...
def Menu():
    ...
    global BoutonMulti, BoutonSolo, BoutonTuto, BoutonTraductionAnglais, BoutonBo3, BoutonBo5, ZoneJeu,BoutonPantheon, Francais,Comparaison,BoutonQuitter,Fenetre
    Comparaison=0
    ...
    BoutonTraductionAnglais.place(x=1000,y=520)
    ...
    BoutonPantheon.place(x=1000,y=420)
